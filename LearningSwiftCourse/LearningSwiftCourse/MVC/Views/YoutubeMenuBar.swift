...
class YoutubeMenuBar: UIView {
    ...
    func setupView(){
        ...
        collectionView.register(YoutubeMenuBarCell.self, forCellWithReuseIdentifier: reuseIdentifier)
...
extension YoutubeMenuBar : UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! YoutubeMenuBarCell
