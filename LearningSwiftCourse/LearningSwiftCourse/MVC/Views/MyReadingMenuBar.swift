...
extension MyReadingMenuBar : UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifier, for: indexPath) as! MyReadingMenuBarCell
...
extension MyReadingMenuBar : UICollectionViewDelegate {
...
extension MyReadingMenuBar : UICollectionViewDelegateFlowLayout {
