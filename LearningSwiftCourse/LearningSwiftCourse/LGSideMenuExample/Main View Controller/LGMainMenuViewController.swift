//
//  LGMainMenuViewController.swift
...
class LGMainMenuViewController: LGSideMenuController {
    ...
    func setup() {
        ...
        if (self.storyboard != nil) {
            ...
            leftViewController = LGLeftViewController()
            rightViewController = LGRightViewController()
...
//        }
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        print("main view controller view will appear ")
