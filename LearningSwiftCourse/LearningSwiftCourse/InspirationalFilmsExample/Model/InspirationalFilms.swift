...
//            }
    ...
    static func inspirationalFilmsList() -> [InspirationalFilms]
    {
       return [ 
        ...
        InspirationalFilms(title: "Heaven Is For Real", description: "",coverImage: "HeavingIsForReal", maxImage: 0, maxVideos: 0, filmInfo:InspirationalFilmsInfo(year: 2014, rating: Rating.Brilliant, genres: [Genres.Drama, Genres.Family,Genres.Fantasy])),
        ...
        InspirationalFilms(title: "Steve Jobs", description: "",coverImage: "SteveJobs", maxImage: 0, maxVideos: 0, filmInfo:InspirationalFilmsInfo(year: 2015, rating: Rating.Excellent, genres: [Genres.Drama, Genres.Biography])),
        ...
        InspirationalFilms(title: "Tracks", description: "",coverImage: "Tracks", maxImage: 0, maxVideos: 0, filmInfo:InspirationalFilmsInfo(year: 2014, rating: Rating.Brilliant, genres: [Genres.Drama, Genres.Biography, Genres.Adventure])),
