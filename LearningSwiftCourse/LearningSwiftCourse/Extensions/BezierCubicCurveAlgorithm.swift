...
public class BezierCubicCurveAlgorithm
{
    private var firstControlPoints: [CGPoint?] = []
    private var secondControlPoints: [CGPoint?] = []
    
    func controlPointsFromPoints(dataPoints: [CGPoint]) -> [BezierCubicCurveSegment] {
        ...
        var controlPoints = [BezierCubicCurveSegment]()
        
        for i in 0..<count{
            if let firstControlPoint = firstControlPoints[i],
                let secondControlPoint = secondControlPoints[i] {
                let segment = BezierCubicCurveSegment(controlPoint1: firstControlPoint, controlPoint2: secondControlPoint)
