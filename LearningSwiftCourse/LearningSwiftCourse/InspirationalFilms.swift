...
class InspirationalFilms {
    ...
    static func inspirationalFilmsList() -> [InspirationalFilms]
    {
       return [ 
        ...
        InspirationalFilms(title: "The Words", description: "",coverImage: "TheWords", filmInfo:InspirationalFilmsInfo(year: 2012, rating: Rating.Outstanding, genres: [Genres.Drama, Genres.Romance, Genres.Mystery])),
        ...
        InspirationalFilms(title: "Coach Carter", description: "", coverImage: "CoachCarter", filmInfo:InspirationalFilmsInfo(year: 2005, rating: Rating.Excellent, genres: [Genres.Biography,Genres.Drama, Genres.Sport])),
        InspirationalFilms(title: "Woman In Gold", description: "",coverImage: "WomanInGold", filmInfo:InspirationalFilmsInfo(year: 2015, rating: Rating.Outstanding, genres: [Genres.Biography,Genres.Drama,Genres.History])),
        InspirationalFilms(title: "The Founder", description: "",coverImage: "thefounder", filmInfo:InspirationalFilmsInfo(year: 2016, rating: Rating.Excellent, genres: [Genres.Drama,Genres.Biography,Genres.History])),
        
        
        InspirationalFilms(title: "Ali", description: "",coverImage: "Ali", filmInfo:InspirationalFilmsInfo(year: 2001, rating: Rating.Brilliant, genres: [Genres.Biography,Genres.Sport,Genres.Drama])),
        InspirationalFilms(title: "A Few Good Men", description: "",coverImage: "AFewGoodMen", filmInfo:InspirationalFilmsInfo(year: 1992, rating: Rating.Excellent, genres: [Genres.Drama, Genres.Thriller])),
        InspirationalFilms(title: "American Gangster", description: "",coverImage: "AmericanGangster", filmInfo:InspirationalFilmsInfo(year: 2007, rating: Rating.Excellent, genres: [Genres.Drama,Genres.Crime,Genres.Biography])),
        InspirationalFilms(title: "American Sniper", description: "",coverImage: "AmericanSniper", filmInfo:InspirationalFilmsInfo(year: 2014, rating: Rating.Excellent, genres: [Genres.Action,Genres.Crime,Genres.Biography])),
        InspirationalFilms(title: "Awakenings", description: "",coverImage: "Awakenings", filmInfo:InspirationalFilmsInfo(year: 1990, rating: Rating.Brilliant, genres: [Genres.Drama,Genres.Biography])),
        InspirationalFilms(title: "Bugsy", description: "",coverImage: "Bugsy", filmInfo:InspirationalFilmsInfo(year: 1991, rating: Rating.Excellent, genres: [Genres.Biography, Genres.Drama, Genres.Crime])),
        InspirationalFilms(title: "Casino", description: "",coverImage: "Casino", filmInfo:InspirationalFilmsInfo(year: 1995, rating: Rating.Brilliant, genres: [Genres.Drama, Genres.Crime])),
        InspirationalFilms(title: "Catch Me If You Can", description: "",coverImage: "CatchMeIfYouCan", filmInfo:InspirationalFilmsInfo(year: 2002, rating: Rating.Outstanding, genres: [Genres.Drama,Genres.Crime])),
        InspirationalFilms(title: "Dead Poets Society", description: "",coverImage: "DeadPoetsSociety", filmInfo:InspirationalFilmsInfo(year: 1989, rating: Rating.Outstanding, genres: [Genres.Drama,Genres.Comedy])),
        InspirationalFilms(title: "Glengarry Glen Ross", description: "",coverImage: "GlengarryGlenRoss", filmInfo:InspirationalFilmsInfo(year: 1992, rating: Rating.Excellent, genres: [Genres.Drama])),
        InspirationalFilms(title: "Goodfellas", description: "",coverImage: "GoodFellas", filmInfo:InspirationalFilmsInfo(year: 1990, rating: Rating.Excellent, genres: [Genres.Crime,Genres.Drama])),
        InspirationalFilms(title: "Joy", description: "",coverImage: "Joy", filmInfo:InspirationalFilmsInfo(year: 2015, rating: Rating.Excellent, genres: [Genres.Drama])),
        InspirationalFilms(title: "Malcolm X", description: "",coverImage: "MalcolmX", filmInfo:InspirationalFilmsInfo(year: 1992, rating: Rating.Excellent, genres: [Genres.History,Genres.Biography,Genres.Drama])),
        InspirationalFilms(title: "Men Of Honor", description: "",coverImage: "MenOfHonor", filmInfo:InspirationalFilmsInfo(year: 2000, rating: Rating.Brilliant, genres: [Genres.Biography, Genres.Drama])),
        InspirationalFilms(title: "Pay It Forward", description: "",coverImage: "PayItForward", filmInfo:InspirationalFilmsInfo(year: 2000, rating: Rating.Outstanding, genres: [Genres.Drama])),
        InspirationalFilms(title: "Raging Bull", description: "",coverImage: "RagingBull", filmInfo:InspirationalFilmsInfo(year: 1980, rating: Rating.Excellent, genres: [Genres.Drama,Genres.Sport,Genres.Biography])),
        InspirationalFilms(title: "Schindler's List", description: "",coverImage: "SchindlersList", filmInfo:InspirationalFilmsInfo(year: 1993, rating: Rating.Outstanding, genres: [Genres.Drama,Genres.History,Genres.Biography])),
        InspirationalFilms(title: "Straight Outta Compton", description: "",coverImage: "StraightOuttaCompton", filmInfo:InspirationalFilmsInfo(year: 2015, rating: Rating.Excellent, genres: [Genres.Drama,Genres.History,Genres.Biography])),
        InspirationalFilms(title: "The Aviator", description: "",coverImage: "TheAviator", filmInfo:InspirationalFilmsInfo(year: 2004, rating: Rating.Brilliant, genres: [Genres.Drama,Genres.History,Genres.Biography])),
        ...
        InspirationalFilms(title: "The Hurricane", description: "",coverImage: "TheHurricane", filmInfo:InspirationalFilmsInfo(year: 1999, rating: Rating.Excellent, genres: [Genres.Biography,Genres.Sport,Genres.Drama])),
        InspirationalFilms(title: "The Imitation Game", description: "",coverImage: "TheImitationGame", filmInfo:InspirationalFilmsInfo(year: 2014, rating: Rating.Brilliant, genres: [Genres.Biography,Genres.Thriller,Genres.Drama])),
        InspirationalFilms(title: "The Pianist", description: "",coverImage: "ThePianist", filmInfo:InspirationalFilmsInfo(year: 2002, rating: Rating.Outstanding, genres: [Genres.War,Genres.Biography,Genres.Drama])),
        InspirationalFilms(title: "The Way Back", description: "",coverImage: "TheWayBack", filmInfo:InspirationalFilmsInfo(year: 2010, rating: Rating.Excellent, genres: [Genres.Adventure,Genres.History,Genres.Drama])),
        InspirationalFilms(title: "The Wolf Of Wall Street", description: "",coverImage: "TheWolfofWallStreet", filmInfo:InspirationalFilmsInfo(year: 2013, rating: Rating.Brilliant, genres: [Genres.Drama,Genres.Comedy])),
        InspirationalFilms(title: "Titanic", description: "",coverImage: "Titanic", filmInfo:InspirationalFilmsInfo(year: 1997, rating: Rating.Brilliant, genres: [Genres.Drama,Genres.Romance])),
        InspirationalFilms(title: "Whiplash", description: "",coverImage: "Whiplash", filmInfo:InspirationalFilmsInfo(year: 2014, rating: Rating.Excellent, genres: [Genres.Drama])),
        ...
        InspirationalFilms(title: "Lord Of The Rings: The Two Towers", description: "",coverImage: "LordOfTheRingsTheTwoTowers", filmInfo:InspirationalFilmsInfo(year: 2002, rating: Rating.Brilliant, genres: [Genres.Drama, Genres.Adventure, Genres.Fantasy])),
        InspirationalFilms(title: "Lord Of War", description: "",coverImage: "LordOfWar", filmInfo:InspirationalFilmsInfo(year: 2005, rating: Rating.Excellent, genres: [Genres.Drama, Genres.Crime, Genres.Thriller])),
        InspirationalFilms(title: "The Finest Hours", description: "",coverImage: "TheFinestHours", filmInfo:InspirationalFilmsInfo(year: 2016, rating: Rating.Good, genres: [Genres.Drama, Genres.Action, Genres.History])),
