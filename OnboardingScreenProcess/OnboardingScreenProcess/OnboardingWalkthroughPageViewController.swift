...
public class OnboardingWalkthroughPageViewController: UIPageViewController {
    ...
    public func goToPermisionsViewController(){
        let bundleIdentifier =  Bundle.main.bundleIdentifier
        let bundle = Bundle(identifier: bundleIdentifier!)
        let storyboard = UIStoryboard(name: "Main", bundle: bundle) 
        let permisionVC = storyboard.instantiateViewController(withIdentifier: "MicrophonePermisionsViewController")
        //present(vc, animated: true, completion: nil)
        
        self.navigationController?.pushViewController(permisionVC, animated: true)
    }
